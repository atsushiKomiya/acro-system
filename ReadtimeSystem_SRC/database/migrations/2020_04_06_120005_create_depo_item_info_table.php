...
class CreateDepoItemInfoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('depo_item_info', function (Blueprint $table) {
            // カラム定義
            $table->increments('depo_item_info_id')->comment('デポ取扱商品ID');
    ...
    {
        Schema::dropIfExists('depo_item_info');
    }
}
