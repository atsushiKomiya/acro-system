...
class CreateDepoCalInfoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('depo_cal_info', function (Blueprint $table) {
            // カラム定義
            $table->increments('depo_cal_id')->comment('デポカレンダーID');
    ...
    {
        Schema::dropIfExists('depo_cal_info');
    }
}
